...
import { FallingPetals, FloatingLanterns } from "./TetAnimations";
import {
  LanternIcon,
  HorseIcon,
  ApricotBlossomIcon,
 ...
 */
export const TetAuthLayout = ({ title, subtitle, children, footer }) => {
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-gradient-to-br from-red-50 via-amber-50 to-yellow-50">
      {/* Decorations */}
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute -right-20 top-40 h-80 w-80 rounded-full bg-gradient-to-br from-amber-300/40 to-yellow-300/40 blur-3xl animate-float"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute bottom-20 left-1/4 h-72 w-72 rounded-full bg-gradient-to-br from-red-300/20 to-pink-300/20 blur-3xl animate-float"
        ...
        <div className="w-full max-w-md">
          ...
          <div className="relative overflow-hidden rounded-3xl border-2 border-amber-200 bg-white/90 backdrop-blur-sm shadow-2xl shadow-amber-200/50">
            ...
            <div className="relative bg-gradient-to-r from-red-500 via-red-600 to-amber-500 px-8 py-8 text-center text-white">
              ...
              <div className="absolute right-4 top-4 opacity-30">
                <PeachBlossomIcon
                  className="h-8 w-8 animate-bloom"
            ...
            <div className="flex items-center justify-center gap-4 border-t border-amber-100 bg-gradient-to-r from-amber-50 to-yellow-50 py-4">
              {[
                ...
                <Icon
                  key={i}
                  className={`h-5 w-5 ${
                    i % 2 === 0 ? "text-red-500" : "text-amber-500"
                  } animate-bounce`}
                  style={{
          ...
          <div className="mt-6 text-center">
            <p className="text-sm font-medium text-amber-700 flex items-center justify-center gap-2">
              ...
              <span>Chúc Mừng Năm Mới 2026</span>
              <LanternIcon
                className="h-4 w-4 text-red-500 animate-swing"
                style={{ animationDelay: "1.5s" }}
              />
            </p>
          </div>
